...
import com.valhalla.base.BuildConfig
...
@Singleton
class ValhallaLogger @Inject constructor() : Logger {
    fun setup() {
        if (BuildConfig.DEBUG) {
            Timber.plant(ValhallaDebugTree())
        }
    }
 ...
 */
private class ValhallaDebugTree : Timber.DebugTree() {
